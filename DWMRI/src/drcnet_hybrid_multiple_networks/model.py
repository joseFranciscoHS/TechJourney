...
class DenoiserNet(nn.Module):
    def __init__(
        ...
        logging.info(
            f"Initializing DenoiserNet: input_channels={input_channels}, output_channels={output_channels}, groups={groups}, dense_convs={dense_convs}, residual={residual}, base_filters={base_filters}, output_activation={output_activation}"
        )
